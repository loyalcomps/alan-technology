...
class AccountMoveInherit(models.Model):
    ...
    #                 if line.debit == 0:
    #                     val_1 = line
    #                     partial = self.env['account.partial.reconcile'].search([('credit_move_id', '=', val_1.id)])
    #                     for val in partial:
    ...
    #                 if line.credit == 0:
    #                     val_1 = line
    #         debit = self.env['account.partial.reconcile'].search([('credit_move_id', '=', val_1.id)])
    #         amount_bal=0
    #         for val in debit:
    #             amount_bal += val.debit_amount_currency
    #         payment_vals.append({
    ...
    #                              'date': data.date,
    #                              'memo': data.ref,
    #                              'move_line_id':val_1.id,
    #                              'amount': val_1.credit if val_1.credit !=0 else val_1.debit})
    #
    #
    ...
    def action_open_journal_allocation_wizard(self):
        ...
        for data in self:
            ...
            for line in allocatable_lines:
                ...
                entries = self.env['account.move'].search([('amount_residual','!=',0.0),
