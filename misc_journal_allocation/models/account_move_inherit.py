...
class AccountMoveInherit(models.Model):
    ...
    def action_open_journal_allocation_wizard(self):
        ...
        #         show_reference = True
        #
            for line in data.line_ids.filtered(lambda account:account.account_id.account_type=='asset_receivable'):
        ...
        #
            ...
            print("---length",len(invoice))
        #
            for inv in invoice:
                print("---name",inv.partner_id.name)
                val_2 = 0
