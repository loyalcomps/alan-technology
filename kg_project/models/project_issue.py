    ...
    def _compute_day(self):
        for issue in self:
            ...
            if issue.date_open:
                ...
                issue.working_hours_open = calendar.get_work_hours_count(dt_create_date, dt_date_open, compute_leaves=True, domain=None)
            if issue.date_closed:
                ...
                issue.working_hours_close = calendar.get_work_hours_count(dt_create_date, dt_date_closed, compute_leaves=True, domain=None)
        ...
        try:
            for issue in self:
                if issue.partner_id:
                    ...
                    issue._message_add_suggested_recipient(recipients, email=issue.email_from,
